...
async function register(name, email, password){
    const res = await fetch(`${API}/auth/register?name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&password=${encodeURIComponent(password)}`, {method: 'POST'});
    return res.json();
}
...
/**
 * (NUEVO) Carga el historial y abre el websocket en chat_room.html
 */
